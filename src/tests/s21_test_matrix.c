/**
 * @file s21_matrix_tests.c
 * @brief Тесты для библиотеки s21_matrix с использованием check.h
 *
 * Этот файл содержит тесты для функций библиотеки s21_matrix. Тесты выполняются
 * с использованием библиотеки check.h. Тесты проверяют следующие функции:
 * - s21_create_matrix
 * - s21_remove_matrix
 * - s21_eq_matrix
 * - s21_sum_matrix
